    ...
    <main>
      ...
      <div className="mt-20">
        <div className="flex gap-5 justify-center">
          <div className="w-16 h-32 bg-indigo-200 rounded-lg stagger-box" />
          <div className="w-16 h-32 bg-indigo-300 rounded-lg stagger-box" />
          <div className="w-16 h-32 bg-indigo-400 rounded-lg stagger-box" />
          <div className="w-16 h-32 bg-indigo-500 rounded-lg stagger-box" />
          <div className="w-16 h-32 bg-indigo-600 rounded-lg stagger-box" />
          <div className="w-16 h-32 bg-indigo-700 rounded-lg stagger-box" />
          <div className="w-16 h-32 bg-indigo-800 rounded-lg stagger-box" />
        </div>
      </div>
    </main>
  );
